...
VALUES ("DM01", "ER Modelling", "IS112"), ("DM02", "Data Normalization", "IS112"), ("DM03", "SQL", "IS112"),
       ("ISI01", "Process Diagram", "IS110"), ("ISI02", "Business Process Innovation", "IS110"),
       ("IP01", "Data Structures", "IS111"), ("IP02", "File Handling", "IS111");
...
VALUES ("S1234567A", "student", "GuineaPig", "tester", "test@smu.edu.sg", "NUS", null), ("S9325681G", "admin", "MoreLegit", "trustme", "mryandao@hotmail.com", "SMU", "T03");
